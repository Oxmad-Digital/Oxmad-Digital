...
const PROJECTS = {
  fr: [
    ...
    { id: 7, url: "site-web-lake-view-hotel.vercel.app", category: "Site vitrine", name: "Lake View Hotel", desc: "Site vitrine pour un hôtel au bord du lac d'Ampefy, présentant les chambres, le restaurant et les activités, avec réservation en ligne simplifiée.", kpis: [{ icon: "ti-calendar-check", label: "Réservation en ligne" }, { icon: "ti-photo", label: "Galerie photo" }, { icon: "ti-tools-kitchen-2", label: "Restaurant" }], image: "https://res.cloudinary.com/eee2cbey/image/upload/v1783089825/oxmad-digital_lake-view-hotel_preview_qcwtny.webp" },
  ],
  en: [
    ...
    { id: 7, url: "site-web-lake-view-hotel.vercel.app", category: "Showcase site", name: "Lake View Hotel", desc: "Showcase site for a hotel on the shores of Lake Ampefy, presenting the rooms, restaurant and activities, with a simplified online booking flow.", kpis: [{ icon: "ti-calendar-check", label: "Online booking" }, { icon: "ti-photo", label: "Photo gallery" }, { icon: "ti-tools-kitchen-2", label: "Restaurant" }], image: "https://res.cloudinary.com/eee2cbey/image/upload/v1783089825/oxmad-digital_lake-view-hotel_preview_qcwtny.webp" },
  ],
};
