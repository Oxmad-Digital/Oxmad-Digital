    ...
    <footer className="ox-footer">
      <div className="ox-footer-top">
        ...
        <div className="ox-footer-socials">
          <a href="https://www.linkedin.com/company/oxmad-digital/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          ...
          <a href="https://www.facebook.com/profile.php?id=61581233799197" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
            </svg>
          </a>
          <a href="https://instagram.com/oxmad.digital" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
